            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 first_col_lls">
                    ...
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro first">
                        ...
                        <li><a data-toggle="tab" href="#mailbox"><i class="fas fa-building"></i>Establishments</a>
                        </li>
                        <li><a data-toggle="tab" href="#positions"><i class="fas fa-users"></i>Positions</a>
                        </li>
                        <li><a data-toggle="tab" href="#employees"><i class="fas fa-users"></i>Employees Record</a>
                        </li>
                        <li><a data-toggle="tab" href="#employment_status"><i class="fas fa-users"></i>Employment Status</a>
                        </li>
                    ...
                    <div class="tab-content custom-menu-content">
                        ...
                        <div id="positions" class="tab-pane in  notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown active">
